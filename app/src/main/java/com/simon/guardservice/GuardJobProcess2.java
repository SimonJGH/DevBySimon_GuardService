...
public class GuardJobProcess2 extends JobService {
    ...
    public boolean onStartJob(JobParameters params) {
        ...
        if(!isLocalServiceWork||
                !isRemoteServiceWork){
            this.startService(new Intent(this,LocalGuardService.class));
            this.startService(new Intent(this,RemoteGuardService.class));
    ...
    public JobInfo getJobInfo(){
        JobInfo.Builder builder = new JobInfo.Builder(kJobId++, new ComponentName(this, GuardJobProcess2.class));
